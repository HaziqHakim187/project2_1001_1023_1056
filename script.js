document.addEventListener("DOMContentLoaded", function () {
    ...
    // For toggling dropdown on mobile
...
$(document).ready(function () {
    // Check if the current page has a hash and it's a calendar.html link
    if (window.location.href.indexOf("calendar.html#") !== -1) {
      var hash = window.location.hash;
      // Redirect to calendar.html with jQuery Mobile navigation
      window.location.href = "calendar.html" + hash;
    }
  });
